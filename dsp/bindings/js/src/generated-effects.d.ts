...
export interface ChromaSpiralOptions extends CommonEffectOptions {
  readonly assets?: never;
}

export declare class ChromaSpiral extends Effect {
  static readonly effectType: "ChromaSpiral";
  constructor(options?: ChromaSpiralOptions);
}

export declare function createChromaSpiral(options?: ChromaSpiralOptions): ChromaSpiral;
...
export interface BassManagementOptions extends CommonEffectOptions {
  readonly phase?: "IIR" | "Linear";
  readonly taps?: "8192" | "16384" | "32768";
  readonly roles?: readonly [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number];
  readonly frequencies?: readonly [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number];
  readonly slopes?: readonly [24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96, 24 | 48 | 96];
  readonly routes?: readonly [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number];
  readonly subs?: number;
  readonly lfeFrequency?: number;
  readonly lfeSlope?: 24 | 48 | 96;
  readonly lfeLowpass?: boolean;
  readonly bassGain?: number;
  readonly lfeGain?: number;
  readonly headroom?: number;
  readonly routeInversions?: readonly [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number];
  readonly assets?: IRReverbAssets;
}

export declare class BassManagement extends Effect {
  static readonly effectType: "BassManagement";
  constructor(options?: BassManagementOptions);
}

export declare function createBassManagement(options?: BassManagementOptions): BassManagement;
...
export interface AttackTonalBalanceOptions extends CommonEffectOptions {
  readonly attack?: number;
  readonly tonal?: number;
  readonly attackEnabled?: boolean;
  readonly tonalEnabled?: boolean;
  readonly assets?: never;
}

export declare class AttackTonalBalance extends Effect {
  static readonly effectType: "AttackTonalBalance";
  constructor(options?: AttackTonalBalanceOptions);
}

export declare function createAttackTonalBalance(options?: AttackTonalBalanceOptions): AttackTonalBalance;
...
export interface BassExtenderOptions extends CommonEffectOptions {
  readonly amount?: number;
  readonly outputGain?: number;
  readonly assets?: never;
}

export declare class BassExtender extends Effect {
  static readonly effectType: "BassExtender";
  constructor(options?: BassExtenderOptions);
}

export declare function createBassExtender(options?: BassExtenderOptions): BassExtender;
...
export interface HardClippingOptions extends CommonEffectOptions {
  ...
  readonly oversampling?: 1 | 2 | 4 | 8 | 16;
  readonly assets?: never;
}
...
export interface EffectOptionsByType {
  readonly ChromaSpiral: ChromaSpiralOptions;
  ...
  readonly BassManagement: BassManagementOptions;
  ...
  readonly AttackTonalBalance: AttackTonalBalanceOptions;
  ...
  readonly BassExtender: BassExtenderOptions;
...
export interface EffectClassByType {
  readonly ChromaSpiral: ChromaSpiral;
  ...
  readonly BassManagement: BassManagement;
  ...
  readonly AttackTonalBalance: AttackTonalBalance;
  ...
  readonly BassExtender: BassExtender;
