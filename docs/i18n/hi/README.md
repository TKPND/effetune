...
वर्चुअल ऑडियो डिवाइस के बिना Chrome या Edge के अधिकतम चार टैब को स्वतंत्र चेन, URL के अनुसार प्रीसेट और चुने हुए सैंपल रेट के साथ प्रोसेस करें। [ब्राउज़र एक्सटेंशन गाइड](browser-extension.md) देखें।
...
- चलते ग्राफ़, कवर आर्ट और गाने की जानकारी वाले Visualizer लेआउट
...
### Visualizer में ऑडियो देखना

कंप्यूटर पर ऊपर से, मोबाइल पर **प्लेयर** टैब से या डेस्कटॉप ऐप के **देखें** मेनू से **Visualizer** खोलें। शामिल लेआउट चुनें या **Edit** से ग्राफ़, कवर आर्ट और गाने की जानकारी सजाएँ। बदलाव तुरंत दिखते हैं और अगली बार भी लौटते हैं; नाम वाली कॉपी प्रीसेट डायलॉग से सहेजें। [Visualizer गाइड](visualizer.md) देखें।
...
### सहेजे गए डेटा का बैकअप और रीस्टोर

वेब ऐप, डेस्कटॉप ऐप और ब्राउज़र एक्सटेंशन के बीच सहेजे गए पाइपलाइन प्रीसेट, इफ़ेक्ट प्रीसेट, इम्पल्स रिस्पॉन्स और मापन ले जाने के लिए **सेटिंग्स > बैकअप / रीस्टोर** खोलें। आप अलग-अलग आइटम या पूरी श्रेणी चुन सकते हैं। कोई प्रीसेट चुनने पर उसके लिए ज़रूरी डेटा भी चुना जाता है। ज़रूरी डेटा का चयन हटाने पर उस पर निर्भर प्रीसेट का चयन भी हट जाता है।

वेब और डेस्कटॉप ऐप के बैकअप में नाम वाले Visualizer प्रीसेट और उनकी पृष्ठभूमि की तस्वीरें भी आती हैं, लेकिन वर्तमान लेआउट नहीं।

**मापन डेटा शामिल करें** और **इम्पल्स रिस्पॉन्स डेटा शामिल करें** डिफ़ॉल्ट रूप से चालू होते हैं, जिससे केवल बैकअप फ़ाइल से ही डेटा रीस्टोर किया जा सकता है। इनमें से कोई विकल्प बंद करने पर उस प्रकार के डेटा के केवल संदर्भ सहेजे जाते हैं। ऐसे संदर्भ तभी रीस्टोर हो सकते हैं जब गंतव्य पर वही डेटा पहले से मौजूद हो। इम्पल्स रिस्पॉन्स EffeTune द्वारा प्रबंधित **Impulse Response Library** में रीस्टोर होते हैं। समान सामग्री वाला डेटा मौजूद हो तो उसी का उपयोग होता है; नाम समान लेकिन सामग्री अलग हो तो नाम में क्रमांक जोड़कर नया आइटम सहेजा जाता है। वर्तमान पाइपलाइन, वॉल्यूम, चुना गया प्रीसेट, डिवाइस सेटिंग्स और एक्सटेंशन के URL नियम नहीं बदलते।

हर `.effetune_backup` फ़ाइल की सीमा 256 MB है। चुना गया डेटा इससे बड़ा हो तो उसे अलग-अलग बैकअप में बाँटें। रीस्टोर बीच में रुकने पर पूरे हो चुके आइटम बने रहते हैं और आप उसी फ़ाइल से सुरक्षित रूप से फिर कोशिश कर सकते हैं। बैकअप साझा करने से पहले चयन जाँच लें: इसमें प्रीसेट के नाम और टिप्पणियाँ, मूल इम्पल्स रिस्पॉन्स फ़ाइलें और मापन का विवरण शामिल हो सकता है। संगीत फ़ाइलें, Music Library का डेटा, ऐप की प्राथमिकताएँ, चुने गए डिवाइस, URL नियम, लॉगिन जानकारी और वर्तमान की बिना सहेजी पाइपलाइन शामिल नहीं होते। कोई प्रीसेट ऐसी रूटिंग या इफ़ेक्ट इस्तेमाल करता हो जो ब्राउज़र एक्सटेंशन में लागू नहीं हो सकते, तब भी उसे वहाँ ले जाकर सहेजा जा सकता है और फिर से उसका बैकअप बनाया जा सकता है।
