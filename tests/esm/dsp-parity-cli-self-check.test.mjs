...
test('release acceptance completion follows the requested backend set', () => {
  ...
  const python = backend('python-native', 1007, 2, stateContracts([
  ...
  const javascript = [
    backend('javascript-baseline', 1007, 2, javascriptContracts),
    backend('javascript-simd', 1007, 2, javascriptContracts)
  ];
  ...
  const full = {
    ...
    workletGolden: worklets('chromium-audioworklet', 108, 2),
